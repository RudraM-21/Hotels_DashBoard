...
├── EER diagram.pdf
├── Hotels_Data_Revenue_Insights.pbix
├── requirements.txt
└── README.md
```
...
- 📊 Peak bookings occur during weekends, contributing ~X% higher revenue  
- 💰 Luxury rooms generate the highest ADR but lower occupancy  
- 🌍 City-wise analysis shows highest revenue from <city-name>  
- 📉 Off-season months show a drop in occupancy by X%  
- 🧾 Online platforms contribute majority of bookings
